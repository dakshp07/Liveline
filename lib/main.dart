            ...
            new Column(
              children: [
                     ...
                     new Stack(
                       children: [
                         new Container(
                           ...
                           child: new Text("Blood Pressure",style: TextStyle(fontSize: 30,color: Colors.white,fontFamily: "Maven Pro",fontWeight: FontWeight.w600),),
                         )
                       ],
                     )
                   ],
                       ...
                       new Stack(
                         children: [
                           new Container(
                             height: 100,width: 800,
                             alignment: Alignment.center,
                             child: new Text("Oximetry",style: TextStyle(fontSize: 30,color: Colors.white,fontFamily: "Maven Pro",fontWeight: FontWeight.w600),),
                           )
                         ],
                       )
                     ],
               ...
               new GestureDetector(
                       ...
                       new Stack(
                         children: [
                           new Container(
                             height: 100,width: 800,
                             alignment: Alignment.center,
                             child: new Text("PWV",style: TextStyle(fontSize: 30,color: Colors.white,fontFamily: "Maven Pro",fontWeight: FontWeight.w600),),
                           )
                         ],
                       )
                     ],
                 ...
                 onTap: (){
                   Navigator.push(context,MaterialPageRoute(builder: (BuildContext context)=>PWDetail()));
                 },
               ),
                   ],
                 ),
