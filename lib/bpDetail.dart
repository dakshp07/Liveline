    ...
    return Scaffold(
      ...
      body: new Container(
        ...
        child: new Column(
          children: [
            ...
            new Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                new Text("sys",style: TextStyle(fontSize: 25,color: Colors.white,fontFamily: "Movan Pro")),
                new Padding(padding: const EdgeInsets.symmetric(horizontal: 15),),
                new Text(" dias",style: TextStyle(fontSize: 25,color: Colors.white,fontFamily: "Movan Pro")),
              ],
            ),
              ...
              children: [
                ...
                new Text("/",style: TextStyle(fontSize: 60,color: Colors.white,fontWeight: FontWeight.w600,fontFamily: "Movan Pro")),
                new Padding(padding: const EdgeInsets.symmetric(horizontal: 2),),
                new Text("80",style: TextStyle(fontSize: 70,color: Colors.white,fontWeight: FontWeight.w600,fontFamily: "Movan Pro")),
              ],
            ),
             ...
             children: [
              ...
              new Column(
                children: [
                  ...
                  new Padding(padding: const EdgeInsets.only(top: 10)),
                  new Text("Elevated",style: TextStyle(fontSize: 20,color: Colors.white,fontFamily: "Movan Pro",fontWeight: FontWeight.w700),),
                  new Padding(padding: const EdgeInsets.only(top: 10)),
                  new Text("Hypertension 1",style: TextStyle(fontSize: 20,color: Colors.white,fontFamily: "Movan Pro",fontWeight: FontWeight.w700),),
                  new Padding(padding: const EdgeInsets.only(top: 10)),
                  new Text("Hypertension 2",style: TextStyle(fontSize: 20,color: Colors.white,fontFamily: "Movan Pro",fontWeight: FontWeight.w700),),
                  new Padding(padding: const EdgeInsets.only(top: 10)),
                  new Text("Hypertensive Crisis",style: TextStyle(fontSize: 20,color: Colors.white,fontFamily: "Movan Pro",fontWeight: FontWeight.w700),)
                ],
              ),
              new Padding(padding: const EdgeInsets.symmetric(horizontal: 20),),
              new Column(
                children: [
                  new Text("sys",style: TextStyle(fontSize: 20,color: Colors.white,fontFamily: "Movan Pro",fontWeight: FontWeight.w700),),
                  new Padding(padding: const EdgeInsets.only(top: 15)),
                  new Text("120",style: TextStyle(fontSize: 20,color: Colors.white,fontFamily: "Movan Pro",fontWeight: FontWeight.w700),),
                  new Padding(padding: const EdgeInsets.only(top: 15)),
                  new Text("120-129",style: TextStyle(fontSize: 20,color: Colors.white,fontFamily: "Movan Pro",fontWeight: FontWeight.w700),),
                  new Padding(padding: const EdgeInsets.only(top: 15)),
                  new Text("130-139",style: TextStyle(fontSize: 20,color: Colors.white,fontFamily: "Movan Pro",fontWeight: FontWeight.w700),),
                  new Padding(padding: const EdgeInsets.only(top: 15)),
                  new Text(">140",style: TextStyle(fontSize: 20,color: Colors.white,fontFamily: "Movan Pro",fontWeight: FontWeight.w700),),
                  new Padding(padding: const EdgeInsets.only(top: 15)),
                  new Text(">180",style: TextStyle(fontSize: 20,color: Colors.white,fontFamily: "Movan Pro",fontWeight: FontWeight.w700),),
                ],
              ),
              new Padding(padding: const EdgeInsets.symmetric(horizontal: 10),),
              new Column(
                children: [
                  new Text("dias",style: TextStyle(fontSize: 20,color: Colors.white,fontFamily: "Movan Pro",fontWeight: FontWeight.w700),),
                  new Padding(padding: const EdgeInsets.only(top: 15)),
                  new Text("80",style: TextStyle(fontSize: 20,color: Colors.white,fontFamily: "Movan Pro",fontWeight: FontWeight.w700),),
                  new Padding(padding: const EdgeInsets.only(top: 15)),
                  new Text("<80",style: TextStyle(fontSize: 20,color: Colors.white,fontFamily: "Movan Pro",fontWeight: FontWeight.w700),),
                  new Padding(padding: const EdgeInsets.only(top: 15)),
                  new Text("80-89",style: TextStyle(fontSize: 20,color: Colors.white,fontFamily: "Movan Pro",fontWeight: FontWeight.w700),),
                  new Padding(padding: const EdgeInsets.only(top: 15)),
        ...
        new RaisedButton(
          ...
          onPressed: (){
            launch("https://www.mayoclinic.org/diseases-conditions/high-blood-pressure/symptoms-causes/syc-20373410");
          }
          )
        ],
        ),
