      ...
      body : new SingleChildScrollView(
        ...
        child: new Column(
          children: [
            ...
            new Column(
              children: [
                new Text("Blood Pressure",style: TextStyle(fontSize: 35,color: Colors.white,fontFamily: "Maven Pro",fontWeight: FontWeight.w600)),
              ...
              new Column(
                children: [
                  ...
                  new Padding(padding: const EdgeInsets.only(top: 10)),
                  new Text("128",style: TextStyle(fontSize: 20,color: Colors.white,fontFamily: "Movan Pro",fontWeight: FontWeight.w700),),
                  new Padding(padding: const EdgeInsets.only(top: 10)),
                  new Text("130",style: TextStyle(fontSize: 20,color: Colors.white,fontFamily: "Movan Pro",fontWeight: FontWeight.w700),),
                  new Padding(padding: const EdgeInsets.only(top: 10)),
                  new Text("118",style: TextStyle(fontSize: 20,color: Colors.white,fontFamily: "Movan Pro",fontWeight: FontWeight.w700),),
                  new Padding(padding: const EdgeInsets.only(top: 10)),
                  new Text("128",style: TextStyle(fontSize: 20,color: Colors.white,fontFamily: "Movan Pro",fontWeight: FontWeight.w700),),
                ],
              ),
              ...
              new Column(
                children: [
                  ...
                  new Padding(padding: const EdgeInsets.only(top: 10)),
                  new Text("85",style: TextStyle(fontSize: 20,color: Colors.white,fontFamily: "Movan Pro",fontWeight: FontWeight.w700),),
                  new Padding(padding: const EdgeInsets.only(top: 10)),
                  ...
                  new Padding(padding: const EdgeInsets.only(top: 10)),
                  new Text("115",style: TextStyle(fontSize: 20,color: Colors.white,fontFamily: "Movan Pro",fontWeight: FontWeight.w700),),
                ],
              )
                  ],
                ),
           ...
           new Text("PWV",style: TextStyle(fontSize: 35,color: Colors.white,fontFamily: "Maven Pro",fontWeight: FontWeight.w600)),
                new Padding(padding: const EdgeInsets.only(top:10),),
                new Row(
             children: [
              new Padding(padding: const EdgeInsets.symmetric(horizontal: 5),),
              ...
              new Column(
                children: [
                  ...
                  new Padding(padding: const EdgeInsets.only(top: 10)),
                  new Text("5.20",style: TextStyle(fontSize: 20,color: Colors.white,fontFamily: "Movan Pro",fontWeight: FontWeight.w700),),
                  new Padding(padding: const EdgeInsets.only(top: 10)),
                  new Text("6.80",style: TextStyle(fontSize: 20,color: Colors.white,fontFamily: "Movan Pro",fontWeight: FontWeight.w700),),
                  new Padding(padding: const EdgeInsets.only(top: 10)),
                  new Text("7.25",style: TextStyle(fontSize: 20,color: Colors.white,fontFamily: "Movan Pro",fontWeight: FontWeight.w700),),
                  new Padding(padding: const EdgeInsets.only(top: 10)),
                  new Text("6.85",style: TextStyle(fontSize: 20,color: Colors.white,fontFamily: "Movan Pro",fontWeight: FontWeight.w700),),
                ],
              ),
              new Padding(padding: const EdgeInsets.symmetric(horizontal: 10),),
            ],
